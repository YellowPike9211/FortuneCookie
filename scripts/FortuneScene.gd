...
const FortunesScript = preload("res://scripts/Fortunes.gd")
...
func _ready():
	...
	match mode:
		"wholesome":
			cookie.texture = load("res://assets/cookie_wholesome_cracked.png")
			text.text = Fortunes.get_wholesome()
		"cursed":
			cookie.texture = load("res://assets/cookie_cursed_cracked.png")
			text.text = Fortunes.get_cursed()
		"funny":
			cookie.texture = load("res://assets/cookie_funny_cracked.png")
